...
class OtherIconPanel(rompanel.ROMPanel):
    ...
    def init(self):
        ...
        self.editPanel = rompanel.SpritePanel(self, None, 16, 24, self.palette, scale=8, bg=16, func="edit")
    ...
    def changeIcon(self, num=None):
        ...
        if num is not None:
            ...
            if not self.rom.data["other_icons"][num].loaded:
                self.rom.getOtherIcons(num//4, num//4)
                
            self.icon = self.rom.data["other_icons"][num]
